...
def rec_badge_html(rec):
    ...
    return f'<span class="badge badge-{cls_map.get(rec,\"replace\")}">{rec}</span>'
...
with tab5:
    ...
    with col2:
        ...
        fig_line.add_vline(x='Mar', line_dash='dash', line_color='#8B5CF6',
                          annotation_text='Current month', annotation_font_size=10)
